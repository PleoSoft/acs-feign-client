...
public class ResultNode {
	...
	public ResultNode modifiedAt(Date modifiedAt) {
	...
	public ResultNode createdAt(Date createdAt) {
	...
	public ResultNode archivedAt(Date archivedAt) {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, resultNode.id) && Objects.equals(this.name, resultNode.name)
				&& Objects.equals(this.nodeType, resultNode.nodeType)
				&& Objects.equals(this.isFolder, resultNode.isFolder) && Objects.equals(this.isFile, resultNode.isFile)
				...
				&& Objects.equals(this.parentId, resultNode.parentId) && Objects.equals(this.isLink, resultNode.isLink)
				...
				&& Objects.equals(this.path, resultNode.path) && Objects.equals(this.search, resultNode.search)
	...
	public int hashCode() {
		return Objects.hash(id, name, nodeType, isFolder, isFile, isLocked, modifiedAt, modifiedByUser, createdAt,
				createdByUser, parentId, isLink, content, aspectNames, properties, allowableOperations, path, search,
				archivedByUser, archivedAt, versionLabel, versionComment);
	}
