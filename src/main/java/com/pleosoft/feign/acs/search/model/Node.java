...
public class Node {
	...
	public Node modifiedAt(Date modifiedAt) {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, node.id) && Objects.equals(this.name, node.name)
				&& Objects.equals(this.nodeType, node.nodeType) && Objects.equals(this.isFolder, node.isFolder)
				&& Objects.equals(this.isFile, node.isFile) && Objects.equals(this.isLocked, node.isLocked)
				...
				&& Objects.equals(this.parentId, node.parentId) && Objects.equals(this.isLink, node.isLink)
				&& Objects.equals(this.content, node.content) && Objects.equals(this.aspectNames, node.aspectNames)
	...
	public int hashCode() {
		return Objects.hash(id, name, nodeType, isFolder, isFile, isLocked, modifiedAt, modifiedByUser, createdAt,
				createdByUser, parentId, isLink, content, aspectNames, properties, allowableOperations, path);
	}
