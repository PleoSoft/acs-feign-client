...
public class RequestStats {
	...
	public RequestStats addPercentilesItem(Float percentilesItem) {
		if (this.percentiles == null) {
			this.percentiles = new ArrayList<Float>();
		}
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.field, requestStats.field) && Objects.equals(this.label, requestStats.label)
				&& Objects.equals(this.min, requestStats.min) && Objects.equals(this.max, requestStats.max)
				&& Objects.equals(this.sum, requestStats.sum)
				&& Objects.equals(this.countValues, requestStats.countValues)
				&& Objects.equals(this.missing, requestStats.missing) && Objects.equals(this.mean, requestStats.mean)
	...
	@Override
	public int hashCode() {
		return Objects.hash(field, label, min, max, sum, countValues, missing, mean, stddev, sumOfSquares,
				distinctValues, countDistinct, cardinality, cardinalityAccuracy, excludeFilters, percentiles);
	}
