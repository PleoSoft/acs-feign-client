...
public class Node {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, node.id) && Objects.equals(this.name, node.name)
				...
				&& Objects.equals(this.isFavorite, node.isFavorite) && Objects.equals(this.content, node.content)
				...
				&& Objects.equals(this.path, node.path) && Objects.equals(this.permissions, node.permissions);
	}
