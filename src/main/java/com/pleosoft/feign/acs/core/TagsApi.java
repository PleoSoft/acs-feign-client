...
public interface TagsApi {
	 ...
	 * like this: ```JSON { \"tag\":\"test-tag-1\" } ``` **Note:** You can
	 * create more than one tag by specifying a list of tags in the JSON body
	 * like this: ```JSON [ { \"tag\":\"test-tag-1\" }, { \"tag\":\"test-tag-2\"
	 * } ] ``` If you specify a list as input, then a paginated list rather than
	 * an entry is returned in the response body. For example: ```JSON {
	 * \"list\": { \"pagination\": { \"count\": 2, \"hasMoreItems\": false,
	 ...
	 * @param tagBodyCreate
	 *            (value = "The new tag" ,required=true )
	 * @param fields
	 ...
	 *         code = 403, message = "User does not have permission to create
	 *         tags on the node"),<br/>
	 ...
	 *            ("The identifier of a node.",required=true)
	 * @param tagId
	 *            ("The identifier of a tag.",required=true)
	 * @return value = { <br/>
	 *         code = 204, message = "Successful response"),<br/>
	 *         code = 401, message = "Authentication failed"),<br/>
	 *         code = 403, message = "User does not have permission to delete
	 *         the tag"),<br/>
	 ...
	 *
	 * <p>
	 * Gets a list of tags in this repository. You can use the **include**
	 * parameter to return additional **values** information.
	 * </p>
	 *
	 *
	 * @param skipCount
	 ...
	 *            **fields** parameter. ")
	 * @param include
	 *            ("Returns additional information about the tag. The following
	 *            optional fields can be requested: * count ")
	 * @return value = { <br/>
	 *         code = 200, message = "Successful response", response =
	 *         TagPaging.class),<br/>
	 ...
	 *         or **skipCount** is invalid "),<br/>
	 *         code = 401, message = "Authentication failed"),<br/>
	 *         code = 403, message = "User does not have permission to read tags
	 *         on the node"),<br/>
	 *         code = 404, message = "**nodeId** does not exist "),<br/>
	 *         code = 200, message = "Unexpected error", response =
	 *         Error.class)<br/>
	 ...
	 *            ("The identifier of a tag.",required=true)
	 * @param tagBodyUpdate
	 *            (value = "The updated tag" ,required=true )
	 * @param fields
	 *            ("A list of field names. You can use this parameter to
	 *            restrict the fields returned within a response if, for
	 *            example, you want to save on overall bandwidth. The list
