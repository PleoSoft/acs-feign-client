...
public class NodeBodyCreate {
	...
	public NodeBodyCreate properties(Map<String, Object> properties) {
		this.properties = properties;
		return this;
	}

	public NodeBodyCreate putPropertiesItem(String key, Object propertiesItem) {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.name, nodeBodyCreate.name) && Objects.equals(this.nodeType, nodeBodyCreate.nodeType)
	...
	@Override
	public int hashCode() {
		return Objects.hash(name, nodeType, aspectNames, properties, relativePath, association, secondaryChildren,
				targets);
	}
