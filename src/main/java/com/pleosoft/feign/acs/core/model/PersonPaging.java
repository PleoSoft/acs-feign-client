...
public class PersonPaging {
	@JsonProperty("list")
	private PersonPagingList list = null;

	public PersonPaging list(PersonPagingList list) {
		this.list = list;
		return this;
	}
	...
	public PersonPagingList getList() {
		return list;
	}

	public void setList(PersonPagingList list) {
		this.list = list;
	}
