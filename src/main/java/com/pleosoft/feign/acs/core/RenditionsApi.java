...
public interface RenditionsApi {
	 ...
	 *
	 * <p>
	 * **Note:** this endpoint is available in Alfresco 5.2 and newer versions. An
	 * asynchronous request to create a rendition for file **nodeId**. The rendition
	 * is specified by name **id** in the request body: ```JSON { \"id\":\"doclib\"
	 * } ``` Multiple names may be specified as a comma separated list or using a
	 * list format: ```JSON [ { \"id\": \"doclib\" }, { \"id\": \"avatar\" } ] ```
	 * </p>
	 *
	 *
	 * @param nodeId              ("The identifier of a node.",required=true)
	 * @param renditionBodyCreate (value = "The rendition \"id\"." ,required=true )
	 * @return value = { <br/>
	 *         code = 202, message = "Request accepted"),<br/>
	 *         code = 400, message = "Invalid parameter: **nodeId** is not a valid
	 *         format or is not a file or **renditionBodyCreate** is invalid
	 *         "),<br/>
	 ...
	 *         "),<br/>
	 *         code = 409, message = "All requested renditions already exist"),<br/>
	 ...
	 * <p>
	 * **Note:** this endpoint is available in Alfresco 5.2 and newer versions. Gets
	 * a list of the rendition information for each rendition of the the file
