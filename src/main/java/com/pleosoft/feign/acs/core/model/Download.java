...
public class Download {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.filesAdded, download.filesAdded)
				&& Objects.equals(this.bytesAdded, download.bytesAdded) && Objects.equals(this.id, download.id)
				&& Objects.equals(this.totalFiles, download.totalFiles)
				&& Objects.equals(this.totalBytes, download.totalBytes) && Objects.equals(this.status, download.status);
	}
