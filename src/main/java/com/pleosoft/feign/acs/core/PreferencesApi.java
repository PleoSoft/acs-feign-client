...
public interface PreferencesApi {
	 ...
	 *
	 * <p>
	 * Gets a specific preference for person **personId**. You can use the
	 ...
	 *            ("The name of the preference.",required=true)
	 * @param fields
	 ...
	 *         code = 404, message = "**personId** or **preferenceName** does
	 *         not exist "),<br/>
	 ...
	 *
	 * <p>
	 * Gets a list of preferences for person **personId**. You can use the
	 * `-me-` string in place of `<personId>` to specify the currently
	 * authenticated user. Note that each preference consists of an **id** and a
	 * **value**. The **value** can be of any JSON type.
	 * </p>
	 *
	 *
	 * @param personId
