...
public interface CommentsApi {
	 ...
	 *
	 * <p>
	 * Creates a comment on node **nodeId**. You specify the comment in a JSON body
	 * like this: ```JSON { \"content\": \"This is a comment\" } ``` **Note:** You
	 * can create more than one comment by specifying a list of comments in the JSON
	 * body like this: ```JSON [ { \"content\": \"This is a comment\" }, {
	 * \"content\": \"This is another comment\" } ] ``` If you specify a list as
	 ...
	 * @param commentBodyCreate (value = "The comment text. Note that you can also
	 *                          provide a list of comments." ,required=true )
	 ...
	 *         code = 400, message = "Invalid parameter: **commentBodyCreate** is
	 *         invalid "),<br/>
	 ...
	 *         code = 405, message = "Cannot comment on a node of this type"),<br/>
	 *         code = 409, message = "**nodeId** is locked and you are not the lock
	 *         owner "),<br/>
	 ...
	 *
	 * @param nodeId    ("The identifier of a node.",required=true)
	 * @param commentId ("The identifier of a comment.",required=true)
	 * @return value = { <br/>
	 ...
	 *
	 * <p>
	 * Gets a list of comments for the node **nodeId**, sorted chronologically with
	 * the newest comment first.
	 * </p>
	 *
	 *
	 * @param nodeId    ("The identifier of a node.",required=true)
	 ...
	 *         code = 400, message = "Invalid parameter: **nodeId** exists but does
	 *         not identify a file or a folder, or the value of **maxItems** is
	 *         invalid, or the value of **skipCount** is invalid "),<br/>
	 *         code = 401, message = "Authentication failed"),<br/>
	 *         code = 403, message = "User does not have permission read comments on
	 *         the node"),<br/>
	 *         code = 404, message = "**nodeId** does not exist "),<br/>
	 *         code = 200, message = "Unexpected error", response =
	 *         Error.class)<br/>
	 ...
	 * @param nodeId            ("The identifier of a node.",required=true)
	 * @param commentId         ("The identifier of a comment.",required=true)
	 * @param commentBodyUpdate (value = "The JSON representing the comment to be
	 ...
	 *         code = 200, message = "Successful response", response =
	 *         CommentEntry.class),<br/>
	 *         code = 400, message = "Invalid parameter: **commentBodyUpdate** is
	 *         invalid "),<br/>
	 *         code = 401, message = "Authentication failed"),<br/>
