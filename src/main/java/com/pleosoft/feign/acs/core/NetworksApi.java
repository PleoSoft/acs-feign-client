...
public interface NetworksApi {
	 ...
	 *
	 * @param networkId
	 *            ("The identifier of a network.",required=true)
	 * @param fields
	 ...
	 * for **personId**. You can use the `-me-` string in place of `<personId>`
	 ...
	 *         PersonNetworkEntry.class),<br/>
	 *         code = 401, message = "Authentication failed"),<br/>
	 *         code = 404, message = "**personId** or **networkId** does not
	 *         exist "),<br/>
	 *         code = 200, message = "Unexpected error", response =
	 *         Error.class)<br/>
	 *         }
	 ...
	 *
	 * <p>
	 * Gets a list of network memberships for person **personId**. You can use
