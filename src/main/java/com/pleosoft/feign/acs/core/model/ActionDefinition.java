...
public class ActionDefinition {
	...
	/**
	 * Identifier of the action definition — used for example when executing an
	 * action
	 * 
	 * @return id
	 **/
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, actionDefinition.id) && Objects.equals(this.name, actionDefinition.name)
